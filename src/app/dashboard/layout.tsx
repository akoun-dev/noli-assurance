...
export default function DashboardLayout({
  ...
  useEffect(() => {
    ...
    // Ne pas rediriger automatiquement, laisser le middleware gérer l'accès
  }, [status, router])
  ...
  // Si pas de session, afficher un message d'accès non autorisé
  // Le middleware devrait déjà avoir redirigé l'utilisateur
  if (!session) {
    return (
